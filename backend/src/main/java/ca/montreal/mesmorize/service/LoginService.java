...
public class LoginService {
     ...
     * 
     * @param authentication - the authentication object for the user, retrieved by
     *                       the LoginController
    ...
    public String generateToken(Authentication authentication) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
                ...
                .expiresAt(now.plus(7, ChronoUnit.DAYS)) // how long the token is valid for ( 7 days )
                .subject(authentication.getName()) // the username
                .claim("grantedAuthorities", grantedAuthorities) // adding a record in the json object for the
